...
// This file contains modified portions of the code from:
// http://chasen.org/~taku/software/TinySegmenter/tiny_segmenter-0.2.js
// Copyright (c) 2008 Taku Kudo
// Licensed under new BSD License. See THIRD_PARTY/TinySegmenter.txt for details.
...
class TinySegmenterWrapper {
  private tinySegmenter = new TinySegmenter()

  public segment(text: string): { word: string, index: number }[] {
    return this.tinySegmenter.segment(text)
  }
}

export default TinySegmenterWrapper;